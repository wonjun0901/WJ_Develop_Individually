...
fname = '../../../../data/pima-indians-diabetes.csv'
...
# 데이터 전처리
# - 스케일 조정
# - 각 특성의 데이터의 범위를 0 ~ 1 사이로 압출
from sklearn.preprocessing import MinMaxScaler, StandardScaler

mms_scaler = MinMaxScaler().fit(X_train)
ss_scaler = StandardScaler().fit(X_train)

X_train = mms_scaler.transform(X_train)
X_test = mms_scaler.transform(X_test)

# - 특성 추출
# - 모든 특성 데이터에서 중요도가 높은 특성만을 추춣하여
#  데이터를 생성하는 과정
