...
# 4. 학습된 머신러닝 모델의 평가
print("학습 결과 : ", 
      grid.score(X_train, y_encoder.transform(y_train)))
print("테스트 결과 : ", 
      grid.score(X_test, y_encoder.transform(y_test)))
...
dump(grid, "../../save/save_model_using_joblib_iris.joblib")
dump(y_encoder, "../../save/save_model_using_joblib_iris_encoder.joblib")
